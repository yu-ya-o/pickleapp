...
export function TeamsListSEO() {
  return (
    <SEO
      title="ピックルボールサークル・メンバー募集"
      description="全国のピックルボールサークル・メンバー募集情報を掲載。お近くのサークルを探して仲間とプレイしよう。初心者歓迎のサークルも多数掲載中！"
      keywords="ピックルボール, サークル, pickleball, サークル募集, メンバー募集, コミュニティ"
      url="/teams"
    />
  );
}
