...
struct TeamEventCreator: Codable, Hashable {
    ...
    // Convert to User
    func toUser() -> User {
        User(id: id, email: email, name: name, profileImage: profileImage, nickname: nickname, bio: bio, region: region, pickleballExperience: pickleballExperience, gender: gender, skillLevel: skillLevel, duprDoubles: nil, duprSingles: nil, myPaddle: nil, isProfileComplete: isProfileComplete, instagramUrl: nil, twitterUrl: nil, tiktokUrl: nil, lineUrl: nil)
    }
}
